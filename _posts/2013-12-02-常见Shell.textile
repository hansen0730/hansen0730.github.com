...
Server Side:
/bin/su -c '/usr/bin/autossh -M 5678 -NR 19999:localhost:22 user_name@123.123.123.123' - user_name
Client Side:
...
常用
tail -F log/*.log
grep -r "def upload_file" .
find . -type d -exec chmod 755 '{}' \
find . -type f -exec chmod 644 '{}' \
scp file_name  hansen@IPaddr:/home/hansen/
wc -l *.c
head -n 1000 flist | tail -n 10
for i in `seq 0 255`; do echo 192.168.0.$i; done

sed去除文件中注释
以下命令将打印从包含 ”BEGIN” 的行开始，并且以包含 ”END” 的行结束的文本块：
